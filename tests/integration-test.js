...
(async()=>{
  ...
  const child=spawn(process.execPath,['server.js'],{cwd:root,env:{...process.env,PORT:String(appPort),MOVEWORKS_DASHBOARD_URL:`http://127.0.0.1:${upstreamPort}/dashboard`,MOVEWORKS_AI_URL:`http://127.0.0.1:${upstreamPort}/ai`,MOVEWORKS_ASSIGN_URL:`http://127.0.0.1:${upstreamPort}/assign`,MOVEWORKS_NOTIFY_URL:`http://127.0.0.1:${upstreamPort}/notify`,MOVEWORKS_EOD_URL:`http://127.0.0.1:${upstreamPort}/eod`},stdio:['ignore','pipe','pipe']});
  try {
