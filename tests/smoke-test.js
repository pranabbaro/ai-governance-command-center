...
for (const text of ['AI Operations Agent','Command Center','Ageing Tickets','SLA Intelligence','DevOps Governance','Ask Governance AI','Send EOD Report','Moveworks Hackathon','AI SLA Intelligence','Refresh live data','liveKpiAnswer','breached SLA records','startVoice','readAloud','AI OPERATIONS RESULT','SLA Breaches']) {
